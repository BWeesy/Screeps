var spawner = {
    ...
    run: function() {
        ...
        if(harvesters.length < sources.length) {
            ...
            harvesterName = 'harvester' + Math.random().toFixed(3).toString();
        ...
        if(upgraders.length < targetUpgraders) {
            updaterName = 'updater' + Math.random().toFixed(3).toString();
        ...
        if(builders.length < targetBuilders) {
            builderName = 'builder' + Math.random().toFixed(3).toString();
